...
urlpatterns = patterns('',
	...
	url(r'^rename/(?P<id>\d+)', 'main.views.presentations.rename'),
	url(r'^modify-description/(?P<id>\d+)', 'main.views.presentations.modify_description'),
	url(r'^edit/(?P<key>\w+)?$', 'main.views.presentations.edit'),
	url(r'^presentation/export$', 'main.views.presentations.export_presentation'),
	url(r'^presentation/import$', 'main.views.presentations.import_presentation'),
	url(r'^presentation/download/(?P<id>\d+)?$', 'main.views.presentations.download'),
	...
	url(r'^share/(?P<id>\d+)', 'main.views.presentations.share'),
	url(r'^unshare/(?P<id>\d+)', 'main.views.presentations.unshare'),
